# Generated by Django 2.0.5 on 2018-07-27 03:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('class_type', models.SmallIntegerField(choices=[(0, '面授'), (1, '周末'), (2, '网络班')], default=0)),
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Branch')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
                ...
                ('period', models.PositiveSmallIntegerField(default=3, verbose_name='课程周期(月)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_grade', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.ClassList', verbose_name='上课班级')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.SmallIntegerField(choices=[(0, 'QQ群'), (1, '51'), (2, '百度推广'), (3, '知乎'), (4, '转介绍'), (5, '其它')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.CustomerInfo')),
            ],
        ),
        migrations.CreateModel(
            name='StudyRecord',
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.CourseRecord')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Student')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.AddField(
            model_name='customerinfo',
            name='referral_from',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='crm.CustomerInfo', verbose_name='转介绍'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='customerfollowup',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.UserProfile', verbose_name='跟进人'),
        ),
        migrations.AddField(
            model_name='courserecord',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.UserProfile'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Course'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
