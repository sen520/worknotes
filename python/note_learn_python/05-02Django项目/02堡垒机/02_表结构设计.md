...
class RemoteUser(models.Model):
    ...
    password = models.CharField(max_length=64, blank=True, null=True)  # 存储明文密码
...
控制台：python manage.py createsuperuser创建管理员

sen0117@163.com     python123



添加数据：

![添加数据01](.\img\添加数据01.png)

![添加数据02](.\img\添加数据02.png)

![添加数据03](.\img\添加数据03.png)

![添加数据04](.\img\添加数据04.png)

![添加数据05](.\img\添加数据05.png)

![添加数据06](.\img\添加数据06.png)

![添加数据07-绑定host](.\img\添加数据07-绑定host.png)